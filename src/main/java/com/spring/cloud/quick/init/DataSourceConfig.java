...
@Configuration
@MapperScan(basePackages = {"com.spring.cloud.quick.dao"}, sqlSessionFactoryRef = "sqlSessionFactory")
public class DataSourceConfig {
	...
	public SqlSessionFactory sqlSessionFactory() throws Exception {
		...
		factoryBean.setTypeAliasesPackage("com.spring.cloud.quick.entity");
